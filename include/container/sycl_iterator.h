 ...
 */
  ...
  inline accessor_t<acc_md_t>
  get_range_accessor(cl::sycl::handler& cgh, size_t size);
  ...
  */
  template <cl::sycl::access::mode acc_md_t =cl::sycl::access::mode::read_write>
  inline accessor_t<acc_md_t>
  get_range_accessor(cl::sycl::handler& cgh);
...
BufferIterator<element_t>::get_range_accessor(cl::sycl::handler& cgh) {
  return BufferIterator<element_t>::get_range_accessor<acc_md_t>(cgh, BufferIterator<element_t>::get_size());
}
...
template <typename element_t>
template <cl::sycl::access::mode acc_md_t>
inline  typename BufferIterator<element_t>:: template placeholder_accessor_t<acc_md_t>
BufferIterator<element_t>::get_range_accessor(size_t size) {
  return typename BufferIterator<element_t>:: template placeholder_accessor_t<acc_md_t>(
      buffer_, cl::sycl::range<1>(size),
      cl::sycl::id<1>(BufferIterator<element_t>::get_offset()));
}
...
inline typename BufferIterator<element_t>:: template placeholder_accessor_t<acc_md_t>
BufferIterator<element_t>::get_range_accessor() {
  return BufferIterator<element_t>::get_range_accessor<acc_md_t>(BufferIterator<element_t>::get_size());
}
...
inline blas::BufferIterator<scalar_t>
...
template <typename element_t>
inline BufferIterator<element_t>&
BufferIterator<element_t>::operator+=(std::ptrdiff_t offset) {
  offset_ += offset;
  return *this;
}
...
template <typename element_t>
inline BufferIterator<element_t>
BufferIterator<element_t>::operator+(
...
template <typename element_t>
inline BufferIterator<element_t>
BufferIterator<element_t>::operator++(int i) {
...
template <typename element_t>
inline std::ptrdiff_t BufferIterator<element_t>::get_size()
    const {
  return (buffer_.get_count() - offset_);
}

template <typename element_t>
inline std::ptrdiff_t BufferIterator<element_t>::get_offset()
    const {
  return offset_;
}
...
template <typename element_t>
inline void BufferIterator<element_t>::set_offset(
    std::ptrdiff_t offset) {
  offset_ = offset;
}
