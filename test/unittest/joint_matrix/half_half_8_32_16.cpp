 ...
 *
 *  @filename half_half_8_32_16.cpp
 *
 **************************************************************************/
...
const auto SmallMatricesHalfHalfm8n32k16 = ::testing::Combine(
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, SmallMatricesHalfHalfm8n32k16);

template <typename scalar_t>
const auto MediumMatricesHalfHalfm8n32k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(8),                          // jm_m
    ::testing::Values(32),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, MediumMatricesHalfHalfm8n32k16);

template <typename scalar_t>
const auto LargeMatricesHalfHalfm8n32k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(8),                          // jm_m
    ::testing::Values(32),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, LargeMatricesHalfHalfm8n32k16);
