 ...
 *
 *  @filename half_half_32_8_16.cpp
 *
 **************************************************************************/
...
const auto SmallMatricesHalfHalfm32n8k16 = ::testing::Combine(
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, SmallMatricesHalfHalfm32n8k16);

template <typename scalar_t>
const auto MediumMatricesHalfHalfm32n8k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(32),                         // jm_m
    ::testing::Values(8),                          // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, MediumMatricesHalfHalfm32n8k16);

template <typename scalar_t>
const auto LargeMatricesHalfHalfm32n8k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(32),                         // jm_m
    ::testing::Values(8),                          // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, LargeMatricesHalfHalfm32n8k16);
