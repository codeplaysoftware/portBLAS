 ...
 *
 *  @filename half_float_32_8_16.cpp
 *
 **************************************************************************/
...
const auto SmallMatricesHalfFloatm32n8k16 = ::testing::Combine(
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, SmallMatricesHalfFloatm32n8k16);

template <typename scalar_t>
const auto MediumMatricesHalfFloatm32n8k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("float"),                    // output type
    ::testing::Values(32),                         // jm_m
    ::testing::Values(8),                          // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, MediumMatricesHalfFloatm32n8k16);

template <typename scalar_t>
const auto LargeMatricesHalfFloatm32n8k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("float"),                    // output type
    ::testing::Values(32),                         // jm_m
    ::testing::Values(8),                          // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, LargeMatricesHalfFloatm32n8k16);
