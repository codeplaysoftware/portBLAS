 ...
 *
 *  @filename half_float_8_32_16.cpp
 *
 **************************************************************************/
...
const auto SmallMatricesHalfFloatm8n32k16 = ::testing::Combine(
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, SmallMatricesHalfFloatm8n32k16);

template <typename scalar_t>
const auto MediumMatricesHalfFloatm8n32k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("float"),                    // output type
    ::testing::Values(8),                          // jm_m
    ::testing::Values(32),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, MediumMatricesHalfFloatm8n32k16);

template <typename scalar_t>
const auto LargeMatricesHalfFloatm8n32k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("float"),                    // output type
    ::testing::Values(8),                          // jm_m
    ::testing::Values(32),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, LargeMatricesHalfFloatm8n32k16);
