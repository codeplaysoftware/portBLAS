 ...
 *
 *  @filename half_half_16_16_16.cpp
 *
 **************************************************************************/
...
const auto SmallMatricesHalfHalfm16n16k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, SmallMatricesHalfHalfm16n16k16);

template <typename scalar_t>
const auto MediumMatricesHalfHalfm16n16k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(16),                         // jm_m
    ::testing::Values(16),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, MediumMatricesHalfHalfm16n16k16);

template <typename scalar_t>
const auto LargeMatricesHalfHalfm16n16k16 = ::testing::Combine(
    ::testing::Values("half"),                     // input type
    ::testing::Values("half"),                     // output type
    ::testing::Values(16),                         // jm_m
    ::testing::Values(16),                         // jm_n
...
GENERATE_JOINTMATRIX_TEST(JointMatrix, LargeMatricesHalfHalfm16n16k16);
