...
template <typename scalar_t>
const auto BetaNonZeroLDMultipliedInterleaved = ::testing::Combine(
    ::testing::Values(0),                              // offset
    ::testing::Values(1, 5),                           // batch
    ::testing::Values(129),                            // m
    ::testing::Values(129),                            // n
    ::testing::Values(129),                            // k
    ::testing::Values('n', 't'),                       // transa
    ::testing::Values('n', 't'),                       // transb
    ::testing::Values<scalar_t>(3.0),                  // alpha
    ::testing::Values<scalar_t>(7.0),                  // beta
...
GENERATE_GEMM_TEST(BatchGemm, BetaNonZeroLDMultipliedInterleaved);
