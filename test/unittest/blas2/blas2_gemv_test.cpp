...
REGISTER_PREC(long double, 1e-8, naive_gemv_test)

TYPED_TEST(BLAS_Test, naive_gemv_test) {
  using ScalarT = typename TypeParam::scalar_t;
  using ExecutorType = typename TypeParam::executor_t;
  using TestClass = BLAS_Test<TypeParam>;
  using test = class naive_gemv_test;
...
REGISTER_PREC(float, 1e-4, naive_gemv_test_transposed)
REGISTER_PREC(double, 1e-8, naive_gemv_test_transposed)
REGISTER_PREC(long double, 1e-8, naive_gemv_test_transposed)

TYPED_TEST(BLAS_Test, naive_gemv_test_transposed) {
  using ScalarT = typename TypeParam::scalar_t;
  using ExecutorType = typename TypeParam::executor_t;
  using TestClass = BLAS_Test<TypeParam>;
  using test = class naive_gemv_test_transposed;
