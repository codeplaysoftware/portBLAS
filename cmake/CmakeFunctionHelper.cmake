...
target_link_libraries(${func} PRIVATE sycl_blas_common)
...
add_library(${func} OBJECT ${FUNC_SRC})
set_target_compile_def(${func})
target_include_directories(${func} PRIVATE ${SYCLBLAS_SRC} ${SYCLBLAS_INCLUDE} ${SYCLBLAS_COMMON_INCLUDE} ${THIRD_PARTIES_INCLUDE})
target_link_libraries(${func} PRIVATE sycl_blas_common)
message(STATUS "Adding SYCL to target ${func}")
add_sycl_to_target(TARGET ${func} SOURCES ${FUNC_SRC})
...
function(generate_quantize)
  ...
  target_link_libraries(quantize PRIVATE sycl_blas_common)
