...
inline typename SB_Handle::event_t SB_Handle::execute(expression_tree_t t,
                                                      ...
                                                      index_t globalSize,
                                                      index_t shMem) {
  return {execute_tree<vector_size, using_local_memory::enabled>(
...
inline typename SB_Handle::event_t SB_Handle::execute(
  ...
  do {
    ...
    if (frst) {
      ...
      event.push_back(execute_tree<vector_size, using_local_memory::enabled>(
