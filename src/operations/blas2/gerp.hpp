...
struct Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t,
            rhs_2_t>::get_init_idx<N, false, false> {
  using index_t =
...
template <int N>
struct Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t,
            rhs_2_t>::get_init_idx<N, false, true> {
  using index_t =
      Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t, rhs_2_t>::index_t;
...
template <int N>
struct Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t,
            rhs_2_t>::get_init_idx<N, true, true> {
  using index_t =
      Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t, rhs_2_t>::index_t;
...
template <int N>
struct Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t,
            rhs_2_t>::get_init_idx<N, true, false> {
  using index_t =
      Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t, rhs_2_t>::index_t;
  void operator()(index_t& init_idx, const index_t num) { init_idx = num; }
};
...
void Gerp<Single, isColMajor, isUpper, lhs_t, rhs_1_t, rhs_2_t>::eval(
  ...
  const index_t rhs_size = 1 + (N_ - 1) * cl::sycl::abs(incX_1_);
  ...
  auto rhs_ptr = rhs_1_.get_pointer();
  ...
  if (rhs_size < local_range) {
    ...
    index_t idx = id;
    if (idx < rhs_size) {
      const index_t limit = (rhs_size - 1) / local_range + 2;
  ...
  if (global_idx < lhs_size) {
    ...
    value_t rhs_1_val = *(scratch + rhs_1_idx);
    value_t rhs_2_val = *(scratch + rhs_2_idx);
