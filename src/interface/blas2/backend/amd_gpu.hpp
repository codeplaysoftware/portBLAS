 ...
 *
 **************************************************************************/
#ifndef PORTBLAS_GEMV_AMD_GPU_BACKEND_HPP
#define PORTBLAS_GEMV_AMD_GPU_BACKEND_HPP
...
typename SB_Handle::event_t inline _spmv(SB_Handle& sb_handle, index_t _N,
                                         ...
                                         element_t _beta, container_t2 _vy,
                                         increment_t _incy) {
  return blas::internal::_spmv_impl<64, 8, uplo>(sb_handle, _N, _alpha, _mA,
...
typename sb_handle_t::event_t _tpmv(sb_handle_t& sb_handle, index_t _N,
                                    ...
                                    increment_t _incx) {
  return blas::internal::_tpmv_impl<64, 8, uplo, trn, diag>(sb_handle, _N, _mA,
                                                            _vx, _incx);
}
}  // namespace backend
}  // namespace tpmv
