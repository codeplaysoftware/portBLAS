...
typename SB_Handle::event_t inline _spmv(
  ...
  return blas::internal::_spmv_impl<16, 4, uplo>(
...
typename sb_handle_t::event_t _tpmv(sb_handle_t& sb_handle, index_t _N,
                                    ...
                                    increment_t _incx) {
  return blas::internal::_tpmv_impl<16, 4, uplo, trn, diag>(sb_handle, _N, _mA,
                                                            _vx, _incx);
}
}  // namespace backend
}  // namespace tpmv
...
typename sb_handle_t::event_t _trsv(
    ...
    typename sb_handle_t::event_t _dependencies) {
  return blas::internal::_trsv_impl<16, 4, uplo, trn, diag>(
