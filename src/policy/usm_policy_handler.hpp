...
// inline element_t *PolicyHandler<usm_policy>::allocate(
...
// template <typename element_t>
// inline void PolicyHandler<usm_policy>::deallocate(element_t *p) const {
...
// template <typename element_t>
// inline BufferIterator<element_t, usm_policy>
// PolicyHandler<usm_policy>::get_buffer(element_t *ptr) const {
...
//   return BufferIterator<element_t, usm_policy>(buff, offset);
// }

/*
@brief this class is to return the dedicated buffer to the user
@ tparam element_t is the type of the buffer
@tparam BufferIterator<element_t, usm_policy> is the type of the buffer
that user can apply arithmetic operation on the host side
*/

// template <typename element_t>
// inline buffer_t
// PolicyHandler<usm_policy>::get_buffer(
//     buffer_t buff) const {
//   return buff;
// }
...
// template <typename usm_policy::access_mode_t acc_md_t, typename element_t>
// inline typename usm_policy::template default_accessor_t<
//     typename ValueType<element_t>::type, acc_md_t>
// PolicyHandler<usm_policy>::get_range_access(element_t *vptr) {
//   return PolicyHandler<usm_policy>::template get_range_access<element_t,
//                                                                    acc_md_t>(
//       get_buffer(vptr));
// }
...
// template <typename element_t, typename usm_policy::access_mode_t acc_md_t>
// inline typename usm_policy::template default_accessor_t<
//     typename ValueType<element_t>::type, acc_md_t>
// PolicyHandler<usm_policy>::get_range_access(
//     BufferIterator<element_t, usm_policy> buff) {
...
// template <typename element_t>
// inline std::ptrdiff_t PolicyHandler<usm_policy>::get_offset(
...
/*
@brief this function is to get the offset from the actual pointer
@tparam element_t is the type of the BufferIterator<element_t,usm_policy>
*/

// template <typename element_t>
// inline std::ptrdiff_t PolicyHandler<usm_policy>::get_offset(
//     BufferIterator<element_t, usm_policy> buff) const {
...
// template <typename element_t>
// inline typename usm_policy::event_t
// PolicyHandler<usm_policy>::copy_to_device(
//     const element_t *src, BufferIterator<element_t, usm_policy> dst,
//     size_t size) {
...
// template <typename element_t>
// inline typename usm_policy::event_t
// PolicyHandler<usm_policy>::copy_to_host(
//     BufferIterator<element_t, usm_policy> src, element_t *dst,
//     size_t size) {
//   auto event = q_.submit([&](cl::sycl::handler &cgh) {
//     auto acc =
...
// template <typename element_t>
// inline typename usm_policy::event_t PolicyHandler<usm_policy>::fill(
//     BufferIterator<element_t, usm_policy> buff, element_t value, size_t size) {
//   auto event = q_.submit([&](cl::sycl::handler &cgh) {
